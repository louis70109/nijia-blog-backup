...
> A: 由每個 Scrum Team 討論產生

> Q: "Server-Side Developer - Common Platform" 職缺，請問這是屬於哪個 team 呢？
> A:

> Q: 招募時程
> A: 依照每個團隊與職缺數，時程上會有所不同，而若有收到通知信件後等待許久，也請麻煩 ping 我們，我們會加速審查的時間。 參考 Frontend 影片
